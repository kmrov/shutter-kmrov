...
my %upload_plugin_info = (
    'module'                        => "Kmrov",                       #edit (must be the same as 'package')
    'url'                           => "http://kmrov.ru/",           #edit (the website's url)
    'registration'                  => "http://kmrov.ru/",   #edit (a link to the registration page)
    'name'                          => "Kmrov",                       #edit (the provider's name)
    'description'                   => "Upload screenshots to img.kmrov.ru",#edit (a description of the service)
...
sub upload {
    ...
    eval{
        ...
        my %params = (
            'imagedata' => [$upload_filename],
            'id' => strftime("%Y%m%d%H%M%S", localtime(time)),
        );

        my @params = (
            "http://img.kmrov.ru/upload.cgi",
